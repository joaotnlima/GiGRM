...
// ═══════════════════════════════════════════════════════════
//  SCENE 1: HOOK — Caos no WhatsApp
// ═══════════════════════════════════════════════════════════
const MESSAGES = [
  { text: "Podes trabalhar amanhã? Urgente!", x: 120, y: 180, delay: 8, rot: -2 },
  { text: "Estou doente, não vou hoje", x: 680, y: 120, delay: 16, rot: 1.5 },
  { text: "Quem está disponível para a Glovo?", x: 350, y: 340, delay: 24, rot: -1 },
  { text: "RESERVA DUPLICADA OUTRA VEZ 😤", x: 900, y: 280, delay: 32, rot: 2 },
  { text: "O cliente precisa do relatório JÁ", x: 180, y: 500, delay: 40, rot: -1.5 },
  { text: "Alguém livre este fim de semana??", x: 750, y: 450, delay: 48, rot: 0.5 },
  { text: "Desculpa chefe, faltou outra vez", x: 480, y: 620, delay: 56, rot: -2.5 },
  { text: "Onde está o João??", x: 1050, y: 520, delay: 64, rot: 1 },
  { text: "Preciso de 5 às 6 da manhã!!", x: 300, y: 750, delay: 72, rot: -0.5 },
  { text: "Em que grupo meto isto?", x: 820, y: 680, delay: 80, rot: 2 },
  { text: "Já disse ao Pedro!", x: 1150, y: 380, delay: 88, rot: -1 },
  { text: "Alguém cobre a Ana?", x: 550, y: 160, delay: 96, rot: 1.5 },
];
    ...
    >
      ...
      <FadeIn delay={60} style={{ position: "absolute", bottom: 180, width: "100%", textAlign: "center" }}>
        <div style={{ display: "inline-flex", alignItems: "center", gap: 16 }}>
          ...
          >
            <Counter target={238} delay={65} /> por ler
          </span>
        </div>
      </FadeIn>
...
// ═══════════════════════════════════════════════════════════
//  SCENE 2: PONTOS DE DOR
// ═══════════════════════════════════════════════════════════
const PAINS = [
  { icon: "⚠️", text: "Faltas sem aviso", color: C.red },
  { icon: "💬", text: "O WhatsApp é o teu 'sistema'", color: C.whatsapp },
  { icon: "📅", text: "Reservas duplicadas constantes", color: C.orange },
  { icon: "📊", text: "Zero dados para os clientes", color: C.blue },
  { icon: "😤", text: "Clientes insatisfeitos", color: C.purple },
  { icon: "⏰", text: "Horas a coordenar turnos", color: C.red },
];
...
// ═══════════════════════════════════════════════════════════
const STATS = [
  { label: "Trabalhadores Ativos", value: 128, suffix: "", color: C.green },
  { label: "Taxa Disponibilidade", value: 94, suffix: "%", color: C.blue },
  { label: "Parceiros Ativos", value: 12, suffix: "", color: C.purple },
  { label: "Turnos Hoje", value: 47, suffix: "", color: C.orange },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        {["Dashboard", "Trabalhadores", "Disponibilidade", "Parceiros", "Zonas", "Licitações", "Definições"].map(
          (item, i) => {
            const isActive = item === "Disponibilidade";
            return (
      ...
      >
        <FadeIn delay={20}>
          <div style={{ marginBottom: 28 }}>
            ...
            <p style={{ color: C.muted, fontSize: 15, margin: "4px 0 0 0" }}>
              Visibilidade em tempo real de todos os trabalhadores e turnos
            </p>
          </div>
        </FadeIn>
        ...
        <FadeIn delay={260} style={{ position: "absolute", right: 60, bottom: 40 }}>
          ...
          >
            Tempo real. Cada trabalhador. Cada turno. ✓
          </div>
        </FadeIn>
      </div>
    </AbsoluteFill>
  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <div style={{ color: C.muted, fontSize: 11 }}>Trabalhador</div>
            </div>
          </div>
          ...
          <div style={{ padding: "16px 20px" }}>
            ...
            {[
              { time: "06:00 - 10:00", status: "Disponível", color: C.green },
              { time: "10:00 - 14:00", status: "Alocado", color: C.blue, partner: "Uber Eats" },
              { time: "14:00 - 18:00", status: "Disponível", color: C.green },
            ].map((slot, i) => (
      ...
      <div style={{ maxWidth: 500 }}>
        ...
        {[
          "Confirmam em segundos",
          "Notificações automáticas de turno",
          "Sem mais chamadas telefónicas",
          "Uma app para todos os clientes",
        ].map((benefit, i) => (
...
// ═══════════════════════════════════════════════════════════
//  SCENE 6: COMO FUNCIONA
// ═══════════════════════════════════════════════════════════
const STEPS = [
  {
    num: "01",
    title: "Regista a Tua Equipa",
    desc: "Importa trabalhadores em minutos. Define zonas, funções e preferências.",
    icon: "👥",
  },
  {
    num: "02",
    title: "Trabalhadores Usam a App",
    desc: "Confirmam disponibilidade, veem turnos, são notificados. Simples assim.",
    icon: "📱",
  },
  {
    num: "03",
    title: "Tu Vês Tudo",
    desc: "Dashboard em tempo real. Relatórios automáticos. Controlo total.",
    icon: "📊",
  },
];
      ...
      <FadeIn delay={200} style={{ marginTop: 50 }}>
        ...
        >
          <span style={{ color: C.green, fontSize: 16, fontWeight: 600 }}>
            ✓ Já em uso por empresas de logística em Portugal
          </span>
        </div>
      </FadeIn>
    </AbsoluteFill>
        ...
        <div style={{ display: "flex", gap: 20, alignItems: "center" }}>
          ...
          >
            ...
            <div style={{ color: C.white, fontSize: 32, fontWeight: 800 }}>
              €2<span style={{ fontSize: 16, fontWeight: 400, color: C.muted }}>/trabalhador/mês</span>
            </div>
          </div>
          <div
            style={{
          ...
          >
            ...
            <div style={{ color: C.white, fontSize: 32, fontWeight: 800 }}>
              €4<span style={{ fontSize: 16, fontWeight: 400, color: "rgba(255,255,255,0.7)" }}>/trabalhador/mês</span>
            </div>
          </div>
        </div>
      </FadeIn>
...
//  MAIN COMPOSITION
// ═══════════════════════════════════════════════════════════
export const TraggoVideoPt: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: C.dark, fontFamily }}>
      {/* Background ambient music */}
      <Audio src={staticFile("bg-music.mp3")} volume={0.10} />

      {/* Voiceover narration per scene (PT) */}
      <Sequence from={T.HOOK.start + 15}>
        <Audio src={staticFile("vo-scene1-pt-pt.mp3")} volume={0.9} />
      </Sequence>
      <Sequence from={T.PAIN.start + 15}>
        <Audio src={staticFile("vo-scene2-pt-pt.mp3")} volume={0.9} />
      </Sequence>
      <Sequence from={T.REVEAL.start + 10}>
        <Audio src={staticFile("vo-scene3-pt-pt.mp3")} volume={0.9} />
      </Sequence>
      <Sequence from={T.DASHBOARD.start + 15}>
        <Audio src={staticFile("vo-scene4-pt-pt.mp3")} volume={0.9} />
      </Sequence>
      <Sequence from={T.MOBILE.start + 15}>
        <Audio src={staticFile("vo-scene5-pt-pt.mp3")} volume={0.9} />
      </Sequence>
      <Sequence from={T.HOW.start + 10}>
        <Audio src={staticFile("vo-scene6-pt-pt.mp3")} volume={0.9} />
      </Sequence>
      <Sequence from={T.CTA.start + 15}>
        <Audio src={staticFile("vo-scene7-pt-pt.mp3")} volume={0.9} />
      </Sequence>
