...
const MESSAGES = [
  ...
  { text: "DOUBLE BOOKING AGAIN 😤", x: 900, y: 280, delay: 32, rot: 2 },
  ...
  { text: "Where is João??", x: 1050, y: 520, delay: 64, rot: 1 },
...
// ═══════════════════════════════════════════════════════════
const PAINS = [
  { icon: "⚠️", text: "No-shows without warning", color: C.red },
  { icon: "💬", text: "WhatsApp is your 'system'", color: C.whatsapp },
  { icon: "📅", text: "Constant double bookings", color: C.orange },
  { icon: "📊", text: "Zero data for clients", color: C.blue },
  { icon: "😤", text: "Unhappy clients", color: C.purple },
  { icon: "⏰", text: "Hours coordinating shifts", color: C.red },
];
    ...
    >
      ...
      >
        ...
        <FadeIn delay={260} style={{ position: "absolute", right: 60, bottom: 40 }}>
          ...
          >
            Real-time. Every worker. Every shift. ✓
          </div>
        </FadeIn>
      </div>
    </AbsoluteFill>
      ...
      <FadeIn delay={200} style={{ marginTop: 50 }}>
        ...
        >
          <span style={{ color: C.green, fontSize: 16, fontWeight: 600 }}>
            ✓ Already in use by logistics companies in Portugal
          </span>
        </div>
      </FadeIn>
    </AbsoluteFill>
        ...
        <div style={{ display: "flex", gap: 20, alignItems: "center" }}>
          ...
          >
            ...
            <div style={{ color: C.white, fontSize: 32, fontWeight: 800 }}>
              €2<span style={{ fontSize: 16, fontWeight: 400, color: C.muted }}>/worker/mo</span>
            </div>
          </div>
          <div
            style={{
          ...
          >
            ...
            <div style={{ color: C.white, fontSize: 32, fontWeight: 800 }}>
              €4<span style={{ fontSize: 16, fontWeight: 400, color: "rgba(255,255,255,0.7)" }}>/worker/mo</span>
            </div>
          </div>
        </div>
      </FadeIn>
